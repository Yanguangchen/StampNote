...
| Camera and tracking | `capture`, `robotic-control` | `capture.monitor.started`, `capture.vision.started`, `capture.vision.changed`, `tracking.recovered` | `capture.monitor.failed`, `capture.vision.failed`, `tracking.failed` | `errorCode`, `durationMs`, `vision` |
| Live tunnel | `live-tunnel`, `robotic-control` | `live_tunnel.joined`, `live_tunnel.talk.started`, `live_tunnel.audio.in` | `live_tunnel.join_failed`, `live_tunnel.talk.failed` | fixed `status`, `errorCode` |
