...
| Camera and tracking | `capture` | `capture.monitor.started`, `capture.vision.started`, `capture.vision.changed`, `tracking.recovered` | `capture.monitor.failed`, `capture.vision.failed`, `tracking.failed` | `errorCode`, `durationMs`, `vision` |
