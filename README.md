...
- `robotic-control.html`, `robotic-control.css`, `robotic-control.js` — dedicated full-page live camera for robot controls; starts on page open, without MediaPipe
