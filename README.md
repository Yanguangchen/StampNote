...
- `robotic-control.html`, `robotic-control.css`, `robotic-control.js` — dedicated full-page live camera for robot controls, without MediaPipe, plus a robot IP field that opens an iframe
