...
Canonical playbook is the repo-root file [skills.md](../../../skills.md). Read and follow that file in full.

Open [https://stampnote-omega.vercel.app/ai-dashboard](https://stampnote-omega.vercel.app/ai-dashboard) first. If the private-workspace gate is shown, click **Continue with Google** and finish Gmail sign-in before asking anything.
